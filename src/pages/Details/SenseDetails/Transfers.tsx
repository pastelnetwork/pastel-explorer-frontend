            ...
            <TableHead className="table__row-header">
              <TableRow>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.pastelID'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.copySerialNr'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.registrationTxId'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.offerTxId'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.acceptTxId'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.itemTxId'))}
                </TableStyles.TableCell>
                <TableStyles.TableCell className="nowrap">
                  {parse(translate('pages.senseDetails.timestamp'))}
                </TableStyles.TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => (
                <TableRow className="table__row" key={item.transactionHash}>
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.pastelID'))}:`}
                  ...
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.copySerialNr'))}:`}
                    className="cell-content nowrap"
                  >
                    {item.copy_serial_nr ? item.copy_serial_nr : parse(translate('common.na'))}
                  </TableStyles.RowCell>
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.registrationTxId'))}:`}
                    className="cell-content nowrap"
                  >
                  ...
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.offerTxId'))}:`}
                    className="cell-content nowrap"
                  >
                    {item.offer_txid ? (
                      <div className="copy-wrapper">
                  ...
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.acceptTxId'))}:`}
                    className="cell-content nowrap"
                  >
                    {item.accept_txid ? (
                      <div className="copy-wrapper">
                  ...
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.itemTxId'))}:`}
                    className="cell-content nowrap"
                  >
                    {item.item_txid ? (
                      <div className="copy-wrapper">
                  ...
                  <TableStyles.RowCell
                    data-title={`${parse(translate('pages.senseDetails.timestamp'))}:`}
                    className="cell-content nowrap"
                  >
