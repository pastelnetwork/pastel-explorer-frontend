              ...
              <Grid container spacing={1}>
                  ...
                  <Box>
                    ...
                    <TicketStyles.TicketContent>
                      {data.size_of_original_file_mb
                        ? formatBytes(data.size_of_original_file_mb * 1000000)
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <Box>
                    ...
                    <TicketStyles.TicketContent>
                      {data?.tx_info?.multisig_outputs_count
                        ? formatNumber(data?.tx_info.multisig_outputs_count)
                        : parse(translate('common.na'))}
                    </TicketStyles.TicketContent>
                  </Box>
                </Grid>
        ...
        <Box className="raptor-q-parameters">
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <Typography className="title">{parse(translate('pages.tickets.files'))}</Typography>
            </Grid>
          </Grid>
          <Box className="mt-10">
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    ...
                    <TicketStyles.TicketContent>
                      ...
                      {getStorageFee(item.req_burn_txn_amount, usdPrice)}
                    </TicketStyles.TicketContent>
                  </Grid>
                  <Grid item xs={12} sm={6} md={4}>
                    <TicketStyles.TicketTitle>
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    ...
                    <TicketStyles.TicketContent>
                      {formatNumber(item.req_amount)} {getCurrencyName()}{' '}
                      {getStorageFee(item.req_amount, usdPrice)}
                    </TicketStyles.TicketContent>
                  </Grid>
                  <Grid item xs={12} sm={6} md={4}>
                    <TicketStyles.TicketTitle>
