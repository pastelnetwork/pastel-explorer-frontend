...
function MarketVolumePrice() {
  ...
  return (
    <HistoricalStatisticsLayout
      ...
      title={parse(translate('pages.historicalStatistics.marketPriceAndVolume'))}
    >
      <EChartsMultiLineChart
        ...
        yaxisName1={translateDropdown('pages.historicalStatistics.volumeUSD')}
        seriesName={translateDropdown('pages.historicalStatistics.price')}
        seriesName1={translateDropdown('pages.historicalStatistics.vol24h')}
        fixedNum={5}
        fixedNum1={2}
        title={parse(translate('pages.historicalStatistics.marketPriceAndVolume'))}
        info={info}
