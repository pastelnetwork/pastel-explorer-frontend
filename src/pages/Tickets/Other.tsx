...
const Other: React.FC = () => {
  const { data, total, isLoading } = useTickets('other', 10);
    ...
    <Styles.OtherTicketContainer>
      <ExplorerStyles.BlockWrapper className="mt-24 latest-transactions-wrapper">
        <ExplorerStyles.BlockTitle className="latest-blocks">
          Other tickets (Total {formatNumber(total)} tickets)
                ...
                <StyledTableRow key={item.transactionHash} className="table__row">
                  ...
                  <StyledTableCell component="td" scope="row">
                    <RouterLink
                      ...
                      value={formatAddress(item.transactionHash, 10)}
                  ...
                  <StyledTableCell className="nowrap">
                    {getTicketTitle(item.type as TTicketType)}
                  </StyledTableCell>
                  <StyledTableCell className="nowrap">
