...
const PastelNFT: React.FC = () => {
  const { data, total, isLoading } = useTickets('pastelid', 10);
    ...
    <Styles.PastelContainer>
      <ExplorerStyles.BlockWrapper className="mt-24 latest-transactions-wrapper">
        <ExplorerStyles.BlockTitle className="latest-blocks">
          Pastel NFT tickets (Total {formatNumber(total)} tickets)
          ...
          <Table aria-label="customized table" className="custom-table latest-transactions">
            <TableHead className="table__row-header">
              <TableRow>
                ...
                <StyledTableCell>PastelID</StyledTableCell>
            ...
            <TableBody>
                ...
                <StyledTableRow key={item.transactionHash} className="table__row">
                  ...
                  <StyledTableCell component="td" scope="row">
                    <RouterLink
                      ...
                      value={formatAddress(item.transactionHash, 15)}
                  ...
                  <StyledTableCell>
                    <RouterLink
                      ...
                      value={formatAddress(item.pastelID, 15)}
                      title={item.pastelID}
                      className="address-link"
                    />
                  </StyledTableCell>
              ...
              {!data.length && !isLoading ? (
                <StyledTableRow>
                  <StyledTableCell component="td" scope="row" colSpan={4} style={{ padding: 0 }}>
