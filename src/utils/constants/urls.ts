...
export const VOLUME_TRANSACTION_URL = 'v1/transactions/charts/volume-of-transactions';
export const INCOMING_TRANSACTION_URL = 'v1/transactions/charts/incoming-transactions';
...
export const GET_BLOCKS_CHARTS = 'v1/blocks/charts';
export const BLOCK_URL = 'v1/blocks';
export const BLOCK_SIZE_URL = 'v1/blocks/charts/size';
export const STATISTICS_BLOCK_URL = 'v1/blocks/charts/statistics';
