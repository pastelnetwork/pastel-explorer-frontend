...
describe('components/NFTRoyaltyTicket', () => {
  const ticket = {
    ...
    new_pastelID:
      'jXXcKdSL8XAd1kMCkBwe4vMfyZj4Jo5D63nnGzZuXGZuPS7qjax8SayHDHj4Erk2kThZvH7JuoX9PkDeS3q9TY',
    nft_txid: 'ead40b73c1f1c8d5a551a3f05a8d4830651c84f026f0ee865ecf1666c0eb6255',
    price: 65,
    signature:
  ...
  const wrapper = shallow(<NFTRoyaltyTicket ticket={ticket} />);
